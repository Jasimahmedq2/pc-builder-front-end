...
import { setMonitor } from "@/redux/features/parts/partsSlice";
          ...
          >
            <Link href={`/parts/${product?._id}`}>
              ...
              >
                ...
                <Link href="/pcBuilder">
                  <button
                    onClick={() => dispatch(setMonitor(product))}
...
export default ChooseMonitorPage;
ChooseMonitorPage.getLayout = function getLayout(page) {
